...
class PersonDetectionInterface:
    def person_detection_function(self):
        ...
        panel.title("Person Detection Interface")
        Label(panel, text="Person Detection Interface", bg="#4BC5DC", fg="white", width=panel_width, height=2, font=("Calibri", 14)).pack()
        ...
        Label(panel, text="").pack()
        Button(panel, text="Person Detection", width=30, height=2, bg="#4BC5DC", fg="white", command=self.button_command).pack()
        Label(panel, text="").pack()
    ...
    def button_command(self):
        ...
        if file_name.endswith(".jpg") or file_name.endswith(".JPG") or file_name.endswith(".png") or file_name.endswith(".PNG"):
            obj = PersonDetection()
            obj.person_detection_function(file_name)
        else:
